...
public class ExcelUtils {
    ...
    public static String excelWriteToHtml(String sourcePath) {
        ...
        try {
            ...
            String excelHtml = readExcelToHtml(fis, true);
            return excelHtml;
    ...
    private static String convertAlignToHtml(short alignment) {
        String align = "left";
        HorizontalAlignment horAlign = HorizontalAlignment.forInt(alignment);
        switch (horAlign) {
            case LEFT:
                align = "left";
                break;
    ...
    private static String convertVerticalAlignToHtml(short verticalAlignment) {
        ...
        VerticalAlignment vertAlign = VerticalAlignment.forInt(verticalAlignment);
        switch (vertAlign) {
            case BOTTOM:
                valign = "bottom";
                break;
    ...
    public static void main(String[] args) {
        String html = readExcelToHtml("/Volumes/MacData/Data/800x/file/CRC工作台需求清单.xlsx", true);
